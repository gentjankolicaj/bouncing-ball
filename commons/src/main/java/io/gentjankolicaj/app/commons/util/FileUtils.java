...
public class FileUtils {
    ...
    public static String getResourcePath(String resourceName) {
        ...
        String resourcePath = dirPath + HostUtils.getPathSeparator() + "src" + HostUtils.getPathSeparator() + "main" + HostUtils.getPathSeparator() + "resources" + HostUtils.getPathSeparator() + resourceName;
        return resourcePath;
    }
